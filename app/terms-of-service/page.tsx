    ...
    <div className={`min-h-screen bg-gray-100 ${montserrat.className}`}>
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="mb-4 text-gray-700">By accessing or using Ace Planters' services, you agree to be bound by these Terms of Service.</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-black">2. Use of Services</h2>
          <p className="mb-4 text-gray-700">You agree to use our services only for lawful purposes and in accordance with these Terms of Service.</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-black">3. Intellectual Property</h2>
          <p className="mb-4 text-gray-700">The content, features, and functionality of our services are owned by Ace Planters and are protected by copyright, trademark, and other intellectual property laws.</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-black">4. Limitation of Liability</h2>
          <p className="mb-4 text-gray-700">Ace Planters shall not be liable for any indirect, incidental, special, consequential or punitive damages resulting from your use of our services.</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-black">5. Changes to Terms</h2>
          <p className="mb-4 text-gray-700">We reserve the right to modify or replace these Terms of Service at any time. It is your responsibility to check these Terms periodically for changes.</p>
        </div>
      </main>
